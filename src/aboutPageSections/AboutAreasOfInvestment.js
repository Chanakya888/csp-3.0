	...
	return (
		<div className="">
			<div className="xl:flex xl:items-end">
				<div className="pr-6   flex justify-start">
					<div className="relative">
						<Img fluid={aboutData.allContentfulAboutPage.nodes[0].aboutImage4.fluid} alt="Beautiful Skyscraper again" imgStyle={{ objectFit: 'cover' }} className="homepage-image" />
						<div className="overlay-rectangle" id="investment-overlay-1" />
					</div>
				</div>
				<div className="px-6 pt-20">
					...
					<div className="text-4xl leading-h2LineHeight xl:w-full" id="area-of-investment-text">
						{aboutData.allContentfulAboutPage.nodes[0].areasOfInvestmentDesccription.areasOfInvestmentDesccription}
					</div>
				</div>
			</div>
